...
class tx_templavoila_mod1_clipboard {
	...
	function element_getPasteButtons($destinationPointer) {
		...
		$adminAlwaysEnableReferencedPaste = 1;
		$enableReferencedPaste = 0;
		$temp = $BE_USER->userTS['options.']['templavoila.'];
		$adminAlwaysEnableReferencedPaste = isset($temp['admin.']['alwaysEnableReferencedPaste']) ?$temp['admin.']['alwaysEnableReferencedPaste']:$adminAlwaysEnableReferencedPaste;
		$enableReferencedPaste = isset($temp['enableReferencedPaste'])?$temp['enableReferencedPaste']:$enableReferencedPaste;
		if ($enableReferencedPaste>0 || ($adminAlwaysEnableReferencedPaste>0 && $BE_USER->user['admin']==1) )
		{
