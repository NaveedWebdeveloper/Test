					...
					switch((string)$this->MOD_SETTINGS['function'])	{
						...
						*****/
						if ($_POST['submit']==1) {
							...
							$OK = $GLOBALS['TYPO3_DB']->exec_UPDATEquery ("sys_language",'uid IN('.$where.')',array('hidden' => '1'));
							//alle hidden felder auf 0 setzten wenn dem nicht so ist
							$OK2 = $GLOBALS['TYPO3_DB']->exec_UPDATEquery ("sys_language",'NOT( uid IN('.$where.'))',array('hidden'=>'0'));
							//if ($OK==1 && $OK2==1)
						...
						{	
							...
							$this->content .= '
												<tr>
													...
													<td><input type="checkbox" name="lang[]" value="'.$row['uid'].'" '.($row['hidden']==1?'checked="checked"':'').'"></td>
												</tr>';
						}
